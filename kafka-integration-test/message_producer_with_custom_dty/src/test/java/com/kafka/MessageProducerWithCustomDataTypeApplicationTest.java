...
@Testcontainers
class MessageProducerWithCustomDataTypeApplicationTest {
    @Container
    ...
    @Autowired
    private KafkaProducerWithCustomDataType publisher;

    @Test
    public void testSendEventsToTopic() {
        publisher.sendMessageToConfigBasedCreatedToptic(new Customer("263", "test_user", "test@gmail.com", "IT"));
